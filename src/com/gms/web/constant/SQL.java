...
public class SQL {
	...
	public static final String BOARD_INSERT = String.format("INSERT INTO %s(%s,%s,%s,%s,%s,%s) VALUES (article_seq.nextval,?,?,?,0,SYSDATE)",DB.TABLE_BOARD,DB.BOARD_SEQ,DB.MEMBER_ID,DB.BOARD_TITLE,DB.BOARD_CONTENT,DB.BOARD_HITCNT,DB.BOARD_REGDATE);
